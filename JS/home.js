...
const auto = setInterval(function () {
  let list = document.querySelector(".slide  .film:first-child");

  document.querySelector(".slide").appendChild(list);
}, 5000);
document.querySelector(".menu-film .click-ahead").onclick = function async() {
  let list = document.querySelector(".slide  .film:first-child");
  document.querySelector(".slide").appendChild(list);
};
